    ...
    vec![
        ...
        Decl::interface(
            ...
            [
                ...
                Field::new(
                    "connections",
                    TsType::array(TsType::named("ConnectionInfo")),
                ),
                Field::new(
                    "objectsByConnection",
...
fn complex_bridge_with_transport(transport: Transport) -> Bridge {
    let decls = complex_decls();
    let mut bridge =
        Bridge::new(transport).header("// @generated by typeship complex fixture. Do not edit.");
...
fn complex_bridge() -> Bridge {
    complex_bridge_with_transport(Transport::Tauri)
}

fn complex_fetch_bridge() -> Bridge {
    complex_bridge_with_transport(Transport::Fetch)
}
...
#[test]
fn complex_fetch_bridge_matches_large_snapshot() {
    let rendered = complex_fetch_bridge().render();
    let expected = include_str!("../../../fixtures/complex/expected/complex-api-fetch.ts");
